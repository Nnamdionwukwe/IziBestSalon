...
export default function FaceComp() {
  return (
    <div>
      <div>
        ...
        <div className={styles.main2}>
          ...
          <div>
            ...
            <div>
              ...
              <div className={styles.ourDiv}>
                <p>
                  No problem. Our stylists will take the time to talk with you
                  and create the wanted look.
                </p>
              </div>
            </div>
        ...
        <div className={styles.main2}>
          ...
          <div>
            <div className={styles.ourDiv}>
              <p>
                Conditioning treatment is a foundation of any haircare. Try one
                of ours intensively deep conditioning treatments that
                strengthens, revitalizes and gives back natural shine to your
                hair.
              </p>
            </div>
            ...
            <div>
              <div className={styles.blowDIv}>
                <h5>Scalp Re-Balancing Treatment</h5>
              ...
              <div className={styles.ourDiv}>
                <p>
                  For the flaking, irritated and itchy scalp. This re-balancing
                  treatment will relieve itching, reduce flaking, moisture and
                  leave hair feeling fantastic. It smells great, too.
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div>
              ...
              <div className={styles.ourDiv2}>
                <p>
                  *BUC (Based Upon Consultation) Due to industry trends,
                  availability and pricing on all items are subject to change or
