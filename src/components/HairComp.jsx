      ...
      <div>
        ...
        <div className={styles.main2}>
          ...
          <div>
            ...
            <div>
              <div className={styles.blowDIv}>
                <h5>Sugar Treatment - add 15 minutes</h5>
              ...
              <div className={styles.ourDiv}>
                <p>
                  Smoothing sugar rub rich in ingredients for intense
                  exfoliation. Great for over stressed hands and feet.
                </p>
              </div>
            </div>
            ...
            <div>
              <div className={styles.blowDIv}>
                <h5>Paraffin Treatment - add 15 minutes</h5>
              ...
              <div className={styles.ourDiv}>
                <p>
                  Slip your hands into nice warm wax. Great for extra hydration
